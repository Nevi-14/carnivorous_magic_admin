<?php 
	...
	$app_name = "Web eCart Multivendor";
?>
<!doctype html>
<html lang="en">
    <head>
            ...
            <div class="site-wrapper-inner">
                <div class="cover-container">
                    ...
                    <div class="inner cover">
                        ...
                        <p class="lead">This is an Automatic Updater which helps you update your Web eCart Multivendor Website Code From v<?=$current_version;?> to v<?=$latest_version;?> </p>
                        <p>
