                    ...
                    <div class="box-body">
                        ...
                        <div id="packate_div" style="display:none">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group"><label>Length(cms)</label><input type="text" name="length[]" class="form-control "></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Breadth(cms)</label><input type="text" name="breadth[]" class="form-control "></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>Height(cms)</label><input type="text" name="height[]" class="form-control "></div>
                                </div>
                        ...
                        <div id="loose_div" style="display:none;">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group"><label>Weight (kgs)<i class="text-danger asterik">*</i></label><input type="text" name="weight_loose[]" class="form-control"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>length(cms)</label><input type="text" name="length_loose[]" class="form-control"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Breadth(cms)</label><input type="text" name="breadth_loose[]" class="form-control"></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>Height(cms)</label><input type="text" name="height_loose[]" class="form-control"></div>
                                </div>
