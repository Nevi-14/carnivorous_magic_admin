...
if (isset($_POST['btnEdit'])) {
    ...
    if ($permissions['products']['update'] == 1) {
        ...
        if (!empty($name) && !empty($category_id) &&  !empty($serve_for) && empty($error['cancelable']) && empty($error)) {
            if (strpos($name, "'") !== false) {
                        ...
                        <div id="variations">
                            ...
                            ?>
                                    <div class="row packate_div">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group"><label>Weight (kgs)<input type="text" name="weight[]" value='<?= $row['weight']; ?>' class="form-control"></div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group"><label>length(cms)</label><input type="text" name="length[]" value='<?= $row['length']; ?>' class="form-control"></div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group"><label>Breadth(cms)</label><input type="text" name="breadth[]" value='<?= $row['breadth']; ?>' class="form-control"></div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group"><label>Height(cms)</label><input type="text" name="height[]" value='<?= $row['height']; ?>' class="form-control"></div>
                                        </div>
                                ...
                                <div id="packate_div" style="display:none">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group"><label>Weight (kgs)<i class="text-danger asterik">*</i></label><input type="text" name="weight[]" value='<?= $row['weight']; ?>' class="form-control"></div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group"><label>length(cms)</label><input type="text" name="length[]" value='<?= $row['length']; ?>' class="form-control "></div>
                                        </div>
                            ...
                            if ($res[0]['type'] == "loose") {
                                foreach ($res as $row) { ?>
                                    <div class="row loose_div">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group"><label>Weight (kgs)<i class="text-danger asterik">*</i></label><input type="text" name="weight_loose[]" value='<?= $row['weight']; ?>' class="form-control "></div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group"><label>length(cms)</label><input type="text" name="length_loose[]" value='<?= $row['length']; ?>' class="form-control "></div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group"><label>Breadth(cms)</label><input type="text" name="breadth_loose[]" value='<?= $row['breadth']; ?>' class="form-control "></div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group"><label>Height(cms)</label><input type="text" name="height_loose[]" value='<?= $row['height']; ?>' class="form-control "></div>
                                        </div>
                                    </div>
                                <?php } ?>
