...
if (isset($_POST['btnAdd'])) {
    ...
    if ($permissions['products']['create'] == 1) {
        ...
        if (!isset($error['length']) ||  !isset($error['height']) || !isset($error['breadth']) || !isset($error['weight']) || !isset($error['length_loose']) || !isset($error['height_loose']) || !isset($error['breadth_loose']) || !isset($error['weight_loose'])) {
            ...
            if (!empty($name) && !empty($category_id) && !empty($serve_for) && empty($error['other_images']) && empty($error['image']) && empty($error['cancelable']) ) {
                ...
                $sql = "INSERT INTO products (name,tax_id,seller_id,slug,category_id,subcategory_id,image,other_images,description,indicator,manufacturer,made_in,return_status,cancelable_status, till_status,is_approved,return_days,cod_allowed,total_allowed_quantity) VALUES('$name','$tax_id','$seller_id','$slug','$category_id','$subcategory_id','$upload_image','$other_images','$description','$indicator','$manufacturer','$made_in','$return_status','$cancelable_status','$till_status','$is_approved','$return_days','$is_cod_allowed','$total_allowed_quantity')";
                // echo $sql;
                $db->sql($sql);
                    ...
                    <div class="box-body">
                        ...
                        <div id="packate_div" style="display:none">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group"><label>Weight (kgs)</label><input type="text" name="weight[]" value="0" class="form-control"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Length(cms)</label><input type="text" name="length[]"  value="0" class="form-control "></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Breadth(cms)</label><input type="text" name="breadth[]"  value="0" class="form-control "></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>Height(cms)</label><input type="text" name="height[]"  value="0" class="form-control "></div>
                                </div>
                        ...
                        <div id="loose_div" style="display:none;">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group"><label>Weight (kgs)<i class="text-danger asterik">*</i></label><input type="text" name="weight_loose[]"  value="0" class="form-control"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>length(cms)</label><input type="text" name="length_loose[]"  value="0" class="form-control"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Breadth(cms)</label><input type="text" name="breadth_loose[]"  value="0" class="form-control"></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>Height(cms)</label><input type="text" name="height_loose[]"  value="0" class="form-control"></div>
                                </div>
                        ...
                        <div class="form-group">
                            <label for="description">Description :</label> <?= isset($error['description']) ? $error['description'] : ''; ?>
